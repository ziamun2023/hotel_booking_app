...
// import Logo from '../../assets/images/icons8-love-48.png'
            ...
            <nav>
              <>
                ...
                >
                  ...
                  />
                  <span className='px-4 py-1 rounded-l-md bg-rose-400  text-black peer-checked:bg-gray-300'>
                    Guest
                  </span>
                  <span className='px-4 py-1 rounded-r-md bg-gray-300  text-black peer-checked:bg-rose-400'>
                    Host
                  </span>
                </label>
                {/* Menu Links */}
